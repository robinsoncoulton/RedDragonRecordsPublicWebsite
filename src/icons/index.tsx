export { ReactComponent as InstagramIcon } from "../Assets/Icons/instagram-white-icon.svg";
export { ReactComponent as YouTubeIcon } from "../Assets/Icons/youtube-app-white-icon.svg";
